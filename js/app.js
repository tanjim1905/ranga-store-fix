            ...
            <div class="card h-100">
                ...
                <div class="card-footer text-center">
                  <div class="d-flex flex-column flex-md-row justify-content-between">
                    <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="btn px-2 mb-1 mb-md-0 bg-success text-white ">Add to cart</button>
                    <button id="details-btn" class="btn text-white bg-warning  px-2" >See Details</button>
                  </div>
                </div>
            </div>     
        `;
